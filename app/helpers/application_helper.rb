module ApplicationHelper
  ...
  def link_to_add_fields(name, f, association, location, element, html_options={})
    ...
    link_to_function(name, "add_fields('#{element}', '#{association}', '#{escape_javascript(fields)}')", html_options)
  end
  ...
  def link_to_remove_fields(name, f, class_name, html_options={})
    f.hidden_field(:_destroy) + link_to_function(name, "remove_fields(this, '#{class_name}')", html_options)
  end
end